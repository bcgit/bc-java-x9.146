    ...
    extends TestCase
{
    ...
    {
//        SignatureAndHashAlgorithm altAlg = SignatureAndHashAlgorithm.DRAFT_mldsa44;
//        SignatureAndHashAlgorithm change = SignatureAndHashAlgorithm.getInstanceIntrinsic(SignatureAlgorithm.custom_mldsa44);
//        int x = 9146;
...
//        client.setCksCode(CertificateKeySelectionType.cks_default);   // Error (wolfssl side)
        /*
        wolfSSL error occurred, error = 173 line:22563 file:src/internal.c
        wolfSSL error occurred, error = 173 line:10758 file:src/ssl.c
         */
//        client.setCksCode(CertificateKeySelectionType.cks_native);    // Runs as intended
        client.setCksCode(CertificateKeySelectionType.cks_alternate);   // Decryption Error (bc side)
//        client.setCksCode(CertificateKeySelectionType.cks_both);          // illegal_parameter (wolfssl side)
        /*
        Alert type: illegal_parameter
        wolfSSL error occurred, error = 47 line:21379 file:src/internal.c
        wolfSSL error occurred, error = 313 line:14579 file:src/tls13.c
         */
...
//                server.setSupportedCksCode(CertificateKeySelectionType.cks_default);
// this one doesnt work maybe dont add the extensions??
//                server.setSupportedCksCode(CertificateKeySelectionType.cks_native);
//                server.setSupportedCksCode(CertificateKeySelectionType.cks_alternate);
                server.setSupportedCksCode(CertificateKeySelectionType.cks_both);
